...
class BroadcastSendMessage
{
    ...
    public function sendTextMessage($msg, $tagid = null)
    {
        ...
        WechatMassHistoryModel::massSend($this->wechat_id, 0, 'text', $content, $result);
    ...
    public function sendImageMessage($media_id, $tagid = null, $model = null)
    {
        ...
        WechatMassHistoryModel::massSend($this->wechat_id, $media_id, 'image', $content, $result);
    ...
    public function sendVoiceMessage($media_id, $tagid = null, $model = null)
    {
        ...
        WechatMassHistoryModel::massSend($this->wechat_id, $media_id, 'voice', $content, $result);
    ...
    public function sendVideoMessage($media_id, $tagid = null, $model = null)
    {
        ...
        WechatMassHistoryModel::massSend($this->wechat_id, $media_id, 'mpvideo', $content, $result);
    ...
    public function sendMpnewsMessage($media_id, $tagid = null, $model = null)
    {
        ...
        WechatMassHistoryModel::massSend($this->wechat_id, $media_id, 'mpnews', $content, $result);
