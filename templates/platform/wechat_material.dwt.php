    ...
    <div class="col-12">
        <div class="card">
			...
			<div class="card-body">
				...
				<!-- {if $action_link} -->
				<a class="btn btn-light plus_or_reply data-pjax float-right" id="sticky_a" href='{$action_link.href}{if $smarty.get.material}&material=1{/if}'><i class="ft-plus"></i>{$action_link.text}</a>
				<!-- {/if} -->
			</div>
			<div class="card-body">
